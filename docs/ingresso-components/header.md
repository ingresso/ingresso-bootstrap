      ...
      <div class="hd-user-menu">
        <a class="hd-um-link hd-link" data-toggle="collapse" data-parent="#header" href="#hd-umenu-cont">
          ...
          <span class="ic-rounded ic-rd-ingresso ic-rd-size2">
            ...
            <svg class="svg-icon hidden-xs-up" width="30" height="30">
            ...
            <div class="hd-umenu-options col-xs-12 col-md-3">
              <ul id="tab">
                ...
                <li class="hidden-md-up">
                  <a class="tab-accordion model1 collapsed" role="button" data-toggle="collapse" data-parent="#tab" href="#tab-main-content02" aria-expanded="true" aria-controls="tab-main-content01">Atendimento</a>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-lg">
                          <div role="listbox" class="filter">
                            <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content01">
                            ...
                            <div class="filter-content collapse" id="filter-content01">
                              <div class="filter-wp">
                                <ul class="list-group list-group-nostyle filter-options">
                                  <li role="option" class="list-group-item filter-it"><a href="#">Ação</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Alternativo</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Animação</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Aventura</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Biografia</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Comédia</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Comédia Dramática</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Comédia Romântica</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Documentário</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Drama</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-lg">
                          <div role="listbox" class="filter">
                            <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content02">
                            ...
                            <div class="filter-content collapse" id="filter-content02">
                              <div class="filter-wp">
                                <ul class="list-group list-group-nostyle filter-options">
                                  <li role="option" class="list-group-item filter-it"><a href="#">O Artista</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">8 1/2</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">A comunidade</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">A Fantástica Fábrica de Chocolate - 1971</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">A Noite Americana</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">A Passageira</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Agnus dei</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Aquarius</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Ártico</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Batman: O Retorno da Dupla Dinâmica</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-lg">
                          <div role="listbox" class="filter">
                            <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content03">
                            ...
                            <div class="filter-content collapse" id="filter-content03">
                              <div class="filter-wp">
                                <ul class="list-group list-group-nostyle filter-options">
                                  <li role="option" class="list-group-item filter-it"><a href="#">Bangu</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Barra da Tijuca</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Botafogo</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cachambi</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Campo Dos Afonsos</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Campo Grande</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Catete</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Centro</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Copacabana</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Del Castilho</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-lg">
                          <div role="listbox" class="filter">
                            <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content04">
                            ...
                            <div class="filter-content collapse" id="filter-content04">
                              <div class="filter-wp">
                                <ul class="list-group list-group-nostyle filter-options">
                                  <li role="option" class="list-group-item filter-it"><a href="#">Centro Cultural Luiz Severiano Ribeiro</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cine 10 Carrefour Sulacap</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cine Araújo Jardim Guadalupe</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cine Joia</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cine Joia Rio Shopping</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">CineCarioca Méier</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cinemark Barra Downtown</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cinemark Botafogo</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cinemark Carioca Shopping</a></li>
                                  <li role="option" class="list-group-item filter-it"><a href="#">Cinemark Jacarepagua</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-xs-12 col-lg">
                          <div role="listbox" class="filter">
                            <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content05">
                            ...
                            <div class="filter-content collapse" id="filter-content05">
                              <div class="filter-wp">
                                <ul class="date-lt date-month-lt2">
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="10/07/2016">
                                      <time datetime="10/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">10</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="11/07/2016">
                                      <time datetime="11/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">11</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="12/07/2016">
                                      <time datetime="12/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">12</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="13/07/2016">
                                      <time datetime="13/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">13</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="14/07/2016">
                                      <time datetime="14/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">14</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="15/07/2016">
                                      <time datetime="15/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">15</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="16/07/2016">
                                      <time datetime="16/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">16</strong>
                                      </time>
                                    </a>
                                  </li>
                                  <li class="date-it" role="option">
                                    <a href="#" class="date-lk" data-val="17/07/2016">
                                      <time datetime="17/07/2016" title="2015-07">
                                        <span class="date-info">JUL</span>
                                        <strong class="date-main-info">17</strong>
                                      </time>
                                    </a>
                                  </li>
                                 <li class="date-it" role="option">
              ...
              <div class="hd-mm-cont hd-cont collapse" id="hd-mm-cont2">
                <div class="hd-cont-wp">
                  ...
                  <div class="row hd-mm-filters">
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content26">
                          <span class="filter-label">Gênero</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content27">
                          <span class="filter-label">Filmes</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content28">
                          <span class="filter-label">Bairro</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content29">
                          <span class="filter-label">Cinemas</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content30">
                          <span class="filter-label">Data</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
              ...
              <div class="hd-mm-cont hd-cont collapse" id="hd-mm-cont3">
                <div class="hd-cont-wp">
                  ...
                  <div class="row hd-mm-filters">
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content06">
                          <span class="filter-label">Gênero</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content07">
                          <span class="filter-label">Filmes</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content08">
                          <span class="filter-label">Bairro</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content09">
                          <span class="filter-label">Cinemas</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content10">
                          <span class="filter-label">Data</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
              ...
              <div class="hd-mm-cont hd-cont collapse" id="hd-mm-cont4">
                <div class="hd-cont-wp">
                  ...
                  <div class="row hd-mm-filters">
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content11">
                          <span class="filter-label">Gênero</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content12">
                          <span class="filter-label">Filmes</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content13">
                          <span class="filter-label">Bairro</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content14">
                          <span class="filter-label">Cinemas</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content15">
                          <span class="filter-label">Data</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
              ...
              <div class="hd-mm-cont hd-cont collapse" id="hd-mm-cont5">
                <div class="hd-cont-wp">
                  ...
                  <div class="row hd-mm-filters">
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content16">
                          <span class="filter-label">Gênero</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content17">
                          <span class="filter-label">Filmes</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content18">
                          <span class="filter-label">Bairro</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content19">
                          <span class="filter-label">Cinemas</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content20">
                          <span class="filter-label">Data</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
              ...
              <div class="hd-mm-cont hd-cont collapse" id="hd-mm-cont6">
                <div class="hd-cont-wp">
                  ...
                  <div class="row hd-mm-filters">
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content21">
                          <span class="filter-label">Gênero</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content22">
                          <span class="filter-label">Filmes</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content23">
                          <span class="filter-label">Bairro</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content24">
                          <span class="filter-label">Cinemas</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
                    ...
                    <div class="col-xs-12 col-lg">
                      <div role="listbox" class="filter">
                        <span class="filter-head collapsed js-lg" data-toggle="collapse" href="#filter-content25">
                          <span class="filter-label">Data</span>
                          <span class="filter-val"></span>
                          <span class="filter-action"></span>
                        </span>
